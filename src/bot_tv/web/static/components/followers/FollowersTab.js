          ...
          ? html`
              <div class="section">
                <div class="section-header" style="color:var(--success)">
                  <span class="section-icon"><i class="fa-solid fa-user-plus"></i></span> Nuevos
                  (${sync.new_count})
                </div>
                <div class="section-body">
          ...
          ? html`
              <div class="section">
                <div class="section-header" style="color:var(--danger)">
                  <span class="section-icon"><i class="fa-solid fa-user-minus"></i></span> Dejaron
                  de seguir (${sync.lost_count})
                </div>
                <div class="section-body">
                  <div class="follower-list">

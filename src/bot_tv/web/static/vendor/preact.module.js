...
function T(n, l, u, t, i) {
  ...
  if (s)
    for (r = 0; r < a; r++)
      null != (e = u[r]) && 0 == (2 & e.__u) && (e.__e == t && (t = $(e)), K(e, e));
  return t;
}
function j(n, l, u, t) {
  var i, r;
  ...
  n.__e != l &&
    (t && (l && n.type && !l.parentNode && (l = $(n)), u.insertBefore(n.__e, l || null)),
    (l = n.__e));
  do {
    l = l && l.nextSibling;
    ...
    try {
      if (
        ...
        t.__c
          ...
          : (x
              ? (u.__c = h = new T(k, $))
              : ((u.__c = h = new C(k, $)), (h.constructor = T), (h.render = Q)),
            M && M.sub(h),
            h.state || (h.state = {}),
            (h.__n = i),
            (p = h.__d = !0),
        ...
        x &&
          ...
          m(h.__s, T.getDerivedStateFromProps(k, h.__s))),
        (v = h.props),
        (y = h.state),
        (h.__v = u),
        p)
        ...
        if (
          ...
          u.__v == t.__v ||
            (!h.__e &&
              ...
              !1 === h.shouldComponentUpdate(k, h.__s, $)))
        ) {
...
function G(u, t, i, r, o, e, f, c, a) {
  ...
  if (null == x) m === k || (c && u.data == k) || (u.data = k);
    ...
    if (
      ((e = 'textarea' == x && null != k.defaultValue ? null : e && n.call(u.childNodes)),
      !c && null != e)
    )
    ...
    if (h)
      (c || (p && (h.__html == p.__html || h.__html == u.innerHTML)) || (u.innerHTML = h.__html),
        (t.__k = []));
    else if (
      (p && (u.innerHTML = ''),
      L(

...
- **Verificación del Índice**: Antes de realizar cualquier consulta, comprueba si existe la carpeta `.lancedb`. Si no existe, ejecuta primero `ingest_codebase` para generar el índice inicial.
